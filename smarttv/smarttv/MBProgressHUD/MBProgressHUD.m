...
#warning GrowingIO will cause button display issue, fix this if you want use HUD with button
            [view setContentCompressionResistancePriority:0.f forAxis:UILayoutConstraintAxisHorizontal];
            [view setContentCompressionResistancePriority:0.f forAxis:UILayoutConstraintAxisVertical];
        } else {
